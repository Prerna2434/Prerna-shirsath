...
export const ASSETS = {
  // Brand logo
  logo: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA2zBoRnOIF4TjTDzAusCAsXtgaOJlsNt4cASvkm4VzgUT_tJu-XRJVMbJiqrFQJ6GdQOEm2TtTJROjNiwMbyOxSFV6jq3RxDWgQtolSLjPix_sDkp-11sbMMb0o6ZPm7ujSjwM1nQuYgeeZ653mHZLZzpalsVkX8fk4-vS9aZ6XgEClHs88owSzx3enp_eotSUMJfC6rlI2IA-8qhbsrVFrqOExorSBvn16syLCED0Ev4MgPOMUg1JGw',
  // Mobile pill emblem logo
  mobileLogo: 'https://lh3.googleusercontent.com/aida/AEtjO1UjjZOWuShmySR4UcmGSAxDY42Bdd5xU1BEpEI9U7VQX3M1Q5aPE4kjiSKOQkcQVmQN5lfnq_vDZG3eH3vfd-6gQDYJ59iAupkcIFzBf0OsJQM6wW6yUerc2IREltX2hILaSsmfou2k7QgRf2c4aS2u8tb3PCQZz8kHqgMKHVmlodN9EbzzDgkugtebVG70x9y-_qdUqqvpLUTMRQrCTX8MjFyqmJ1aP06zrUTG9XaW6epJZXSyFHYb5bo',
  // Dr. Evelyn Vance avatar
  drEvelynVance: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBFCfPKkB2BWjyQ-UFGa_AGt2LDjt6uMda4zSVzMk003H7PkkoIAzlu0EELvhfojYlymmuHI9Dx_fScl8hcC_3RaSGReUcHiiKO5iyNQF_8kCXwSS0qNr6WLk6vSatLeONFZFQ0NMR8fOSJSYHpZnsUR2dntDBQ-ihdu6DdsayY-OGdhxUDMup6bpnc4sMng3ENjFwYxxBbfWBBikuxpGMlb_9DDGGqgKuS2ZcsnMHoKESOGVpcd3VYsQ',
  // Dispensary clean room / storage pods
  pharmacyVault: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDi8gRKG5JU8ou-NydKahlaCyjjQwGPUSz0cliWMV6VzSHLgPG8l9vse_iyUbBu6ki6RIHOAi4YtjpSrcW-Yj3TvoHGOIRza1xp_bUwngTnmU3klhyonIj4Wp93cggSvmOFeKkIzP_Hr2Apw6ib4QZD_QrTgLGuvSNyY1JnMUOXrayLXw5ZtyW7fXPcUnAclC8YZxIfvn7ViOVYJu00C6kribcJvOT-yjwabAbXJwuFGem3E0flReysoA',
  // Pharmacist Marcus Vance
  pharmacistMarcus: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCgqIKKJmkC-BDaRqeUIHYTGVhd11q8Rf4uxEZMzQbF3AFJVSWtklYi2bYl5ID7PL5pPKqrdce0J3TREg7OFKfIGEmsOTZR8ajJRkXC6tgJMZsqGpFv2bH3_kRV704IWR2zPSLEbPXrNgIF9lsWqDyrk5MSE1v47FEyN1nB6AEi4DAwzcNeOgtF2ro9kqjMLDf56eH6KPUc_5cR952aBBzwJVIYeTyv96yBMXTzey4RilXkPg_8HKyzpA',
  // Prescriptions thumbnails
  rxSlipRobertChen: 'https://lh3.googleusercontent.com/aida-public/AB6AXu
 'https://lh3.googleusercontent.com/aida-public/AB6AXuB654T0ydq77NBBRd_3YawfHJkU6gFHbjnOipjZ-GUr3VSLswIGdRY6x4AXl3hLGLJcIcR8sWzTyEZl1DOQ7zfTyEqpszgyvLxbcVPYf3fap9hZoMbW3aSwKhE0esQvtrn-WgrBbyJ5pzMzjclf5mUL3pVlelcLGiZshQ1swa3QX6lw8d45LT0yben9kB0GNVD0vOVeNqdnAxv7eaNAtQRrLqZwleq-HLC46WhqUO9orGpdyo6_70vhxA'
};

export const INITIAL_DISPENSARY_STOCK: DispensaryStockItem[] = [
  {
    id: 'stock-1',
...
export const INITIAL_LIVE_ORDERS: DispensaryOrder[] = [
  {
    id: 'ord-9082',
  ...
  },
  {
    ...
    items: [
      { name: 'Amoxicillin 500mg (21 ct)', quantity: '21 ct', price: 9.15 }
    ],
...
export const PRESCRIPTION_CASES: PrescriptionCase[] = [
  {
    ...
    thumbnailUrl: ASSETS.rxSlipRobertChen
  },
  {
    id: 'case-2',
    ...
    thumbnailUrl: ASSETS.rxSlipSarahJenkins
  },
  {
    id: 'case-3',
    ...
    thumbnailUrl: ASSETS.rxSlipDavidVance
  },
  {
    id: 'case-4',
    ...
    thumbnailUrl: ASSETS.rxSlipMariaSantos
  },
  {
    id: 'case-5',
    ...
    thumbnailUrl: ASSETS.rxSlipThomasWu
  }
];

export const COMPETING_PHARMACIES: CompetingPharmacy[] = [
  {
    rank: 1,
  ...
  {
    rank: 2,
    name: 'CareFirst Pharmacy Hub',
    license: 'License: #TX-77312',
    rating: 4.8,
    reviewCount: 1890,
    genericProduct: 'Atorvastatin Calcium 20mg',
    ...
    patientPrice: 11.50,
    copay: 2.30,
    savingsPercentage: 87.6,
    savingsDollars: 81.00,
    fulfillmentSla: '45 Mins Express',
    distanceOrCarrier: '1.2 miles away'
  },
  {
    rank: 3,
    name: 'Community Health Rx',
    license: 'License: #TX-44019',
    rating: 4.6,
    reviewCount: 920,
    genericProduct: 'Atorvastatin Calcium 20mg',
    ...
    savingsDollars: 79.50,
    fulfillmentSla: 'Standard Next-Day',
    distanceOrCarrier: 'USPS Carrier'
  },
  {
    rank: 4,
    name: 'Prime Meds Direct',
    license: 'License: #TX-10992',
    rating: 4.7,
    reviewCount: 4100,
    genericProduct: 'Lipitor 20mg (Original Brand)',
    manufacturer: 'Pfizer US Pharmaceuticals',
    ndc: '0071-0156-23',
    patientPrice: 88.00,
    copay: 25.00,
    savingsPercentage: 4.8,
    savingsDollars: 4.50,
    fulfillmentSla: '2-3 Business Days',
    distanceOrCarrier: 'Standard Freight',
    isBrandOnly: true
  }
];

export const TENANT_SCHEMAS: TenantSchema[] = [
  {
    id: 'tenant-1',
...
export const LIVE_ARBITRAGE_TRANSACTIONS: ArbitrageTransaction[] = [
  {
    id: 'tx-1',
